...
public class ProgramaPublicacao {

    public static void main(String args[]) {

        Scanner sc = new Scanner(System.in);
        String titulo, autor, genero, editora, direcao, ator, sinopse, edicao, tempoDeDuracao;
        int anoPublicacao, quantidadeDisponivel;
        long isbn;
        ...
        Livro livro = new Livro(titulo,  autor,  anoPublicacao,  genero,  editora,  quantidadeDisponivel,  edicao,  isbn);
        ...
        tempoDeDuracao = sc.next();
        System.out.println("\n\n");

        Filme filme = new Filme(titulo, autor, anoPublicacao, genero, editora, quantidadeDisponivel, direcao, ator, sinopse, tempoDeDuracao);
